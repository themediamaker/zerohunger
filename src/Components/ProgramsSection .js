...
const ProgramsSection = () => {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 md:max-w-lg">
              <h2 className="text-xl md:text-2xl font-bold mb-2">The Visionary Behind Mission</h2>
  ...
  <div className="flex flex-col md:flex-row justify-between items-center">
    <div className="mb-4 md:mb-0 md:max-w-lg">
      <h2 className="text-xl md:text-2xl font-bold mb-2 whitespace-nowrap truncate">
